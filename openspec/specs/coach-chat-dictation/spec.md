# coach-chat-dictation Specification

## Purpose
Record → server transcript → composer paste for Coach chat (web parity). Audio is not kept as a chat attachment; TTS is out of scope.

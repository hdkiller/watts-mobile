...
**Reason**: Replaced by the named Active Recovery Context band, which includes Log event plus Check in and History as secondary actions.
**Migration**: Use the Active Recovery Context band Log event control (same recovery-event create route).

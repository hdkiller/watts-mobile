...
- [x] 3.2 Manual pass: interval workout shows a legible silhouette; steady/unstructured workouts show no profile; zone bars and zone list use the same colors

...
5. [ ] Set EAS env `GOOGLE_MAPS_API_KEY` (or `EXPO_PUBLIC_GOOGLE_MAPS_API_KEY`) for Android activity maps — required; missing key crashes `MapView` ([../../native-modules.md](../../native-modules.md)).

...
| Apple Paid Apps Agreement/tax/banking; Google merchant profile; prices/products | [019](./distribution/tasks/019-paid-agreements-and-products.md) | in-progress (Apple bank account-holder info verified and DAC7 submitted; confirm ASC status; Play bank verify + 15% enrolled; draft catalogs) |

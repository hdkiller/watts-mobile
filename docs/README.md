# Coach Watts Mobile — Docs

Implementation docs for the native companion app. Product narrative originally drafted in coach-wattz PR [#239](https://github.com/hdkiller/coach/pull/239) (`docs/06-plans/mobile-companion-app.md`).
